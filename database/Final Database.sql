...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2024 at 02:14 PM
...
INSERT INTO `thesis` (`ThesisId`, `Title`, `AdviserId`, `InstructorId`, `School`, `SchoolYear`, `DateOfFinalDefense`, `Status`, `CreatedBy`, `CreatedDate`, `LastModifiedBy`, `LastModifiedDate`) VALUES
(1, 'Thesis Management System', 7, 12, 'SAINT MARY’S UNIVERSITY', '2024', '2024-04-15', 'In Progress', 'System Admin', '2024-04-22', 'Instructor One', '2024-05-09'),
(2, 'My Test Thesis', 1, 13, 'SAINT MARY’S UNIVERSITY', '2024', '2024-04-16', 'In Progress', 'System Admin', '2024-04-22', 'Student Five', '2024-05-09'),
...
(8, 'Testing Only', 7, 6, 'SAINT MARY’S UNIVERSITY', '2023', '2024-05-15', 'In Progress', 'RC', '2024-05-05', 'Student Five', '2024-05-09');
...
(406, 7, 8, 0, 'Completed'),
(407, 7, 9, 0, 'Completed'),
(408, 7, 10, 0, 'Completed'),
(409, 7, 11, 0, 'Completed'),
(410, 7, 12, 0, 'Completed'),
(411, 7, 13, 0, 'Completed'),
(412, 7, 14, 0, 'Completed'),
(413, 7, 15, 0, 'Completed'),
(414, 7, 16, 0, 'Completed'),
(415, 7, 17, 0, 'Completed'),
(416, 7, 18, 0, 'Completed'),
(417, 7, 19, 0, 'Completed'),
(418, 7, 20, 0, 'Completed'),
(419, 7, 21, 0, 'Completed'),
(420, 7, 22, 0, 'Completed'),
(421, 7, 23, 0, 'Completed'),
(422, 7, 24, 0, 'Completed'),
(423, 7, 25, 0, 'Completed'),
(424, 7, 26, 0, 'Completed'),
(425, 7, 27, 0, 'Completed'),
(426, 7, 28, 0, 'Completed'),
(427, 7, 29, 0, 'Completed'),
(428, 7, 30, 0, 'Completed'),
(429, 7, 31, 0, 'Completed'),
(430, 7, 32, 0, 'Completed'),
(431, 7, 33, 0, 'Completed'),
(432, 7, 34, 0, 'Completed'),
(433, 7, 35, 0, 'Completed'),
(434, 7, 36, 0, 'Completed'),
(435, 7, 37, 0, 'Completed'),
(436, 7, 38, 0, 'Completed'),
(437, 7, 39, 0, 'Completed'),
(438, 7, 40, 0, 'Completed'),
(439, 7, 41, 0, 'Completed'),
(440, 7, 42, 0, 'Completed'),
(441, 7, 43, 0, 'Completed'),
(442, 7, 44, 0, 'Completed'),
(443, 7, 45, 0, 'Completed'),
(444, 7, 46, 0, 'Completed'),
(445, 7, 47, 0, 'Completed'),
(446, 7, 48, 0, 'Completed'),
(447, 7, 49, 0, 'Completed'),
(448, 7, 50, 0, 'Completed'),
(449, 7, 51, 0, 'Completed'),
(450, 7, 52, 0, 'Completed'),
(451, 7, 53, 0, 'Completed'),
(452, 7, 54, 0, 'Completed'),
(453, 7, 55, 0, 'Completed'),
(454, 7, 56, 0, 'Completed'),
(455, 7, 57, 0, 'Completed'),
(456, 7, 58, 0, 'Completed'),
(457, 7, 59, 0, 'Completed'),
(458, 7, 60, 0, 'Completed'),
(459, 7, 61, 0, 'Completed'),
(460, 7, 62, 0, 'Completed'),
(461, 7, 63, 0, 'Completed'),
(462, 7, 64, 0, 'Completed'),
(463, 7, 65, 0, 'Completed'),
(464, 7, 66, 0, 'Completed'),
(465, 7, 67, 0, 'Completed'),
(466, 7, 68, 0, 'Completed'),
(467, 7, 69, 0, 'Completed'),
(468, 7, 70, 0, 'Completed'),
(469, 7, 71, 0, 'Completed'),
(470, 7, 72, 0, 'Completed'),
(471, 7, 73, 0, 'Completed'),
(472, 7, 74, 0, 'Completed'),
...
(1, 'Adviser', 'Adviser Two', 'adviser.two', 'c4ca4238a0b923820dcc509a6f75849b', 'nelbuen@test.com', 'What elementary school did you attend?', 'hilo', 'Active'),
...
DROP VIEW IF EXISTS `thesis_groupedstudents_vw`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `thesis_groupedstudents_vw`  AS SELECT `t`.`ThesisId` AS `ThesisId`, `t`.`Title` AS `Title`, group_concat(distinct concat(`s`.`FirstName`,' ',`s`.`LastName`) separator ',') AS `Authors`, `adviser`.`Name` AS `Adviser`, `instructor`.`Name` AS `Instructor`, `t`.`LastModifiedDate` AS `LastModifiedDate`, `t`.`DateOfFinalDefense` AS `DateOfFinalDefense`, `s`.`Course` AS `Course`, `s`.`Department` AS `Department`, `s`.`Year` AS `Year`, `t`.`SchoolYear` AS `SchoolYear`, `t`.`Status` AS `Status` FROM ((((`thesis` `t` left join `thesisstudentmap` `tsm` on(`tsm`.`ThesisId` = `t`.`ThesisId`)) left join `student` `s` on(`tsm`.`StudentId` = `s`.`StudentId`)) left join `users` `adviser` on(`t`.`AdviserId` = `adviser`.`UserId`)) left join `users` `instructor` on(`instructor`.`UserId` = `t`.`InstructorId`)) GROUP BY `t`.`Title`, `adviser`.`Name`, `instructor`.`Name`, `t`.`LastModifiedDate`, `t`.`DateOfFinalDefense`, `t`.`Status` ;
...
DROP VIEW IF EXISTS `thesis_student_panel_editor_vw`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `thesis_student_panel_editor_vw`  AS SELECT `tsp`.`ThesisId` AS `ThesisId`, `tsp`.`Title` AS `Title`, `tsp`.`UserId` AS `UserId`, `tsp`.`StudentName` AS `StudentName`, `tsp`.`Adviser` AS `Adviser`, `tsp`.`PanelMembers` AS `PanelMembers`, `tsp`.`count` AS `count`, `tsp`.`SchoolYear` AS `SchoolYear`, ifnull(`e`.`EditorName`,'') AS `Editor` FROM ((`thesis_student_panel_vw` `tsp` left join `thesis_checklist_editor_map` `tcem` on(`tsp`.`ThesisId` = `tcem`.`ThesisId`)) left join `editor` `e` on(`e`.`EditorId` = `tcem`.`EditorId`)) ;
...
--
ALTER TABLE `thesis_checklist_file_map`
  MODIFY `ThesisChecklistFileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
