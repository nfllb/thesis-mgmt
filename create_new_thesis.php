            ...
            <div class="container d-flex justify-content-center align-items-center ">
                <form id="createForm" class="border shadow p-3 rounded new-thesis-form thesis-modal-color">
                    ...
                    <option value=''>Select Instructor</option>";
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                <label for="year" class="form-label thesis-text-color">School Year <em style="font-size: 11px;">(Format: 20xx-20xx Sem
                                        No.)</em>
                                </label>
            ...
            <div id='thesisContainer' class='card w-100 mb-3'>
                <div class='card-body'>
                    <div style='font-size:16px;'class='alert alert-danger' role='alert>
                        ...
                        Access to this page is restricted as you currently have a pending thesis. Please reach out to your research coordinator for assistance.
                    </div>
                </div>
            </div>
            </div>";
